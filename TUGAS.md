...
Ini arah produk kita, dan semua riset harus memvalidasi ini:

- Makanan Korea asli **sebagian besar tidak cocok dengan lidah orang kita**, terutama yang hasil **fermentasi** — kimchi asli yang asam dan fermentasi kuat, doenjang, dll. Ini fakta, bukan masalah — tugas kita adalah menyesuaikan.
- Jadi rasa akan kita adjust: lebih berani di gurih/manis/pedas, fermentasi diperhalus supaya tidak "asing".
- **TAPI kimchi dan lobak kuning (danmuji) tetap harus ada** — karena itu adalah *wajah* makanan Korea. Tanpa kimchi di samping porsi, orang tidak merasa sedang makan Korean food. Versi kita: lebih segar, tidak terlalu asam, fermentasi ringan.
- Prinsipnya: **orang harus bisa bilang "ini Korean food"** (dari tampilan, nama, kimchi, kemasan) **tapi pas dimakan bilang "ini enak"** (karena rasanya sudah cocok dengan lidah lokal).

Riset kalian harus membuktikan atau membantah asumsi ini dengan data lapangan.

---

## Task 2 — Riset Pasar Lokal (Kediri)

**Tujuan:** memahami kompetitor yang sudah ada, dan menemukan celah visual + celah rasa yang belum mereka isi.

### Sub-task
| No | Sub-task | Yang Diharapkan |
|----|----------|-----------------|
| 2.1 | Buat daftar SEMUA resto/cafe/toko yang jual makanan Korea di Kediri. Cari di Google Maps, GoFood, GrabFood, ShopeeFood, Instagram, TikTok. Kalau resto khusus Korea kurang dari 10, tambahkan yang jual menu Korea sebagai bagian menu (cafe, angkringan modern, rice bowl). | Daftar minimal 10 kompetitor (nama + lokasi) |
| 2.2 | Untuk tiap kompetitor, catat: platform delivery yang aktif, range harga (termurah–termahal), menu best seller (lihat jumlah terjual / label "terlaris" di aplikasi), rating + jumlah review. | Catatan per kompetitor |
| 2.3 | Screenshot identitas visual tiap kompetitor: logo, banner aplikasi delivery, foto menu, feed IG, kemasan (kalau ada foto dari review pelanggan). | Folder screenshot rapi per kompetitor |
| 2.4 | Catat positioning tiap kompetitor: mereka jual apa? Autentik? Murah? Cafe aesthetic? Street food? | 1 kalimat positioning per kompetitor |
| 2.5 | Baca 20–30 review pelanggan per 3 kompetitor terbesar. Catat apa yang dipuji dan yang dikeluhkan — **terutama keluhan soal rasa asing / kimchi / terlalu pedas / terlalu asam.** Ini validasi filosofi produk kita. | Daftar pujian & keluhan yang berulang |
| 2.6 | Kesimpulan: celah visual apa yang belum ada di Kediri? Celah rasa/harga apa yang terbuka? | 5–10 poin kesimpulan |
...
**Tujuan:** data langsung dari calon pembeli — minat, ekspektasi rasa, dan visual yang mereka suka.
...
**Tujuan:** menentukan siapa pembeli paling berpotensi — supaya konten dan iklan kita fokus, tidak nembak ke semua orang.

### Sub-task
| No | Sub-task | Yang Diharapkan |
|----|----------|-----------------|
| 5.1 | Dari hasil survei + observasi sosmed, petakan segmen: pelajar, mahasiswa, pekerja, keluarga, K-pop fans. | Peta segmen |
| 5.2 | Untuk tiap segmen catat: umur, platform favorit, jam biasa pesan makanan, harga yang masuk akal buat mereka, gaya visual yang mereka suka. | Profil per segmen |
| 5.3 | Pilih 1–2 segmen utama yang paling mungkin jadi pembeli pertama. Jelaskan kenapa. | Rekomendasi target utama |
| 5.4 | Cari 10 akun / grup / komunitas lokal tempat segmen ini berkumpul (grup K-pop Kediri, akun info kampus, komunitas WA/Telegram). | Daftar 10 akun/grup |

---

## Pertanyaan yang Harus Terjawab dari Riset Ini

Kalau di akhir riset ini kita bisa jawab semua ini, risetnya sukses:
...
- **Sumber utama:** Google Maps + aplikasi delivery (GoFood/GrabFood/ShopeeFood) langsung dari HP, Instagram, TikTok.
- **Screenshot semuanya.** Data tanpa bukti visual = kurang berguna. Kumpulkan di Google Drive, folder per task (Task 2 / Task 3 / dst).
- Boleh catat di mana saja — Notes HP, Google Docs, bahkan chat WA. **Tidak perlu Excel rapi.**

## Cara Lapor

- **Lapor harian lewat WhatsApp** — foto/screenshot + catatan singkat apa yang ditemukan hari itu. Tidak perlu format formal.
- Yang penting **datanya**, bukan cara lapornya.
- **Stuck rule:** kalau buntu lebih dari 20 menit atau sudah coba 2 cara masih mentok — langsung tanya, jangan diam sampai deadline.
